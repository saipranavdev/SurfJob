...
relatedCompanies = {
    1: ['intel', 'texas instruments', 'amd', 'emc', 'ibm', 'csc',
        'broadcom', 'microsoft', 'apple computers', 'sun microsystems',
        'dell', 'national semiconductor', 'micron',
        'samsung', 'nec', 'motorola'],
    2: ['msdw', 'merril lynch', 'chase',
        'bank one corp', 'aig', 'ids'],
    3: ['general electric', 'cirrus logic'],
    4: ['compaq', 'hewlett packard'],
    5: ['wal-mart', 'gmc'],
    6: ['lockheed', 'general dynamics'],
    7: ['computer associates', 'eds', 'oracle']
}
company_dict = {
    "sam sung": "integrate software and hardware components of 3d digital phones",
    "nec": "",
    "aig": "",
    "amd": "",
    "oracle": "",
    ...
    "microsoft": "develop and test windows based products",
    "bmc": "",
    "chase": "managing sun solaris and compaq tru-64 unix systems",
    "csc": "",
    "broadcom": "",
    "eds": "",
    "motorola": "development of mobiles",
    "ge": "",
    "hewlett packard": "",
    "bank one corp": "",
    "merril lynch": "",
    "gmc": "",
    "ford": "marketing new environment friendly vehicles.",
    "sun microsystems": "managing a large feds funded project involving b2b applications",
    "micron": "",
    "msdw": "",
    "ibm": "",
    "ids": "",
